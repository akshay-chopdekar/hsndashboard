...
include("scripts/hotalinfo2.php");
?>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <ul class="nav">
             ...
             <li><a class="active" href="userReview1.php">User Reviews</a>
             </li>
    ...
    $(document).ready(function (event) {
      ...
      var userTable = $('#example').dataTable( /*{
        ...
        fnRowCallback:function(nRow,aData, iDisplayIndex, iDisplayIndexFull){
          var seenReportedVal =Number($('td:eq(2)', nRow).text());
      console.log($('td:eq(2)', nRow).text());
          if(seenReportedVal==0)
          {
           $(nRow).addClass('bold');
          }
          $('td:eq(2)', nRow).addClass('hideCol');
        },
      });  
    }*/);
  </script>
    ...
    $('#example tbody').on('click', 'tr', function() {
      ...
      .done(function(data) {
        ...
        for(var i=0;i<data['rev'].length;i++)
        {
          ...
          output+="<tr id='"+hotelId+"'><td style='width: 100px'>"+reviews+"</td><td style='width: 50px'>"+status+"</td> <td style='width: 50px'>"+rating+"</td> <td style='width: 50px'>accept <input type='radio' id='a"+reviewid+"w"+hotelId+"W"+yes+"' name='status"+reviewid+"' value='accept'> reject &nbsp;&nbsp;<input type='radio' id='r"+reviewid+"w"+hotelId+"W"+no+"' name='status"+reviewid+"' value='reject'></td></tr>";
        }
        }
        else
        {
