  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-3 navColor" style="width:260px;padding-left: 0px;">
        ...
        <ul class="nav">
          <li><a href="dashboardBlockUser.php">hotel info</a>
          </li>
          <li><a class="active" href="dashboardDeletePost.php">category list</a>
          </li>
          <li><a href="dashboardReporting.php">Reporting</a>
          </li>
          <li><a href="sendCoins.php">Send Coins</a>
          </li>
          <li><a href="sendBet.php">Add bet</a>
          </li>
        </ul>
      </div>
      <div class="col-xs-9">
