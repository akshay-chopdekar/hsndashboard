...
<body>
  <div class="container-fluid">
    <div class="row">
     ...
     <ul class="nav">
       <li><a  href="hotelInfo1.php">Hotel Info</a>
       </li>
       <li><a class="active" href="categoryList1.php">Category List</a>
       </li>
          ...
          <div class="modal-body">
            <table id="modaltable">
              ...
              <tr>
                ...
                <td>
                  <textarea id="description" class="form-control" cols="60" rows="3">
                  </textarea>
                </td>
              </tr>
            </table>
      ...
      // alert("category is"+ $(this).find('td').eq(1).text());
       ...
       .done(function(data) {
         ...
         for(var i=0;i<data['category'].length;i++)
         {
            ...
            output+="<option value="+dat+" name="+tat+">"+dat+"</option>";          
         }
         // console.log(output);
