...
<body>
  <div class="container-fluid">
    ...
    <ul class="nav">
           <li><a class="active" href="hotelInfo11.php">Hotel Info</a>
           </li>
          ...
          <div class="modal-body scrollspy-example" data-spy="scroll" style="height:461px;overflow:-moz-scrollbars-vertical;overflow-y:auto;" id="scroll1">
            ...
            <form class="form-horizontal" role="form" id="myform" enctype="multipart/form-data">
              ...
              <label class="control-label col-sm-2">Breakfast</label>
                <div class="col-sm-10">
                <!-- <input type="checkbox" id="breakfast" class="form-control"></input> -->
                <input class="checkMargin" type="checkbox" name="breakfast" id="breakfast">
                </div>
              </div>
               <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2 labelAlign">wifi</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="wifi" id="wifi">
                </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2 labelAlign " style="font-size:12px">Complementry
                Wifi</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="complementaryWifi" id="complementaryWifi">
                </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Self Parking</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="selfParking" id="selfParking">
                </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2 labelAlign " >SelfParking
                Rate</label>
                <div class="col-sm-10">
                  <input class="form-control newLine zeroOneWidth" type="text" name="selfParkingRate" id="selfParkingRate">
                </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Vale Parking</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="valeParking" id="valeParking">
                </div>
            </div>
            <div class="form-group">
              ...
              <label class="control-label col-sm-2 labelAlign " style="font-size:12px">Complementry
                Parking</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="complementaryParking" id="complementaryParking">
                </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" >Concierge
                Service</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="conciergeService" id="conciergeService">
                </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Pet Friendly</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="petFriendly" id="petFriendly">
                </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Outdoor Pool</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="outdoorPool" id="outdoorPool">
                </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Indoor Pool</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="indoorPool" id="indoorPool">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2" >Fitness Center</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="fitnessCenter" id="fitnessCenter">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Sauna</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="sauna" id="sauna">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Spa Services</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="spaServices" id="spaServices">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Airport Shuttle</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="airportShuttle" id="airportShuttle">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Roof Top</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="rooftop" id="rooftop">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Dry Cleaning</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="dryCleaning" id="dryCleaning">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Ironing</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="ironing" id="ironing">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Non Smoking</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="nonSmoking" id="nonSmoking">
                </div>
            </div>
               <div class="form-group">
              ...
              <label class="control-label col-sm-2" >Around</label>
               ...
               <div class="form-group">
 <!-- here-->        <label class="control-label col-sm-2 labelAlign" >24hrRoom Service</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="24hrRoomService" id="24hrRoomService">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Room Service</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="roomService" id="roomService">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Restaurant
                Onsite</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="restaurantOnsite" id="restaurantOnsite">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >BAR Onsite</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="barOnsite" id="barOnsite">
                </div>
            </div>
               <div class="form-group">
              ...
              <label class="control-label col-sm-2 labelAlign" >FlatScreen TV</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="flatScreenTV" id="flatScreenTV">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Satellite TV</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="satelliteTV" id="satelliteTV">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Mini Bar</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="miniBar" id="miniBar">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Hot Beverages</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="hotBeverages" id="hotBeverages">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Kettle</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="kettle" id="kettle">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Electronic Safe</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="electronicSafe" id="electronicSafe">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Air Conditioning</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="airConditioning" id="airConditioning">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Hair Drier</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="hairDrier" id="hairDrier">
                </div>
            </div>
               <div class="form-group">
              <label class="control-label col-sm-2 labelAlign" >Working Desk</label>
                <div class="col-sm-10">
                  <input class="checkMargin" type="checkbox" name="workingDesk" id="workingDesk">
                </div>
            </div>
               <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input class="form-control newLine zeroOneWidth" type="text" name="district" id="district">
                </div>
              </div>
       ...
       $("#scroll1").scrollTop(0);
        ...
        $("#tradeName").empty();
            ...
            for(var key in data['info'][0])
            {
              ...
              if($("#"+key).is(':checkbox')){
                if(data['info'][0][key]==1)
                {
                  $("#"+key).attr('checked',true);
                  // alert("checked"+key);
                  // alert("hi");
                }
                else if(data['info'][0][key]==0)
                {
                  $("#"+key).attr('checked',false);
                  // alert("unchecked"+key);
                }
              }
              else if($("#"+key).prop('type')=='text')
              {
                // alert("hi");
                // console.log(key);
...
///*******//
    ...
    $('form#myform').on('submit', function (event) {
      ...
      // data.append('timezone',timezone);
       data.append('city',$("#city option:selected").attr('name'));
      



      $.ajax({
          url: "../php/savehotelinfo1.php",
          // async: false,
          data: data,
          type: "POST",
          // dataType: "json",
